	...
	<div id="login_container">
		<form method="post">
			...
			<div id="login_classroom">
				<input name="user_sex" class="input" type="text" placeholder="班级" v-model.trim.lazy="signUpData.classroom" required="required">
			</div>
			<hr class="blank">

			<div id="login_number">
				<input name="user_number" class="input" type="text" placeholder="学号" v-model.trim="signUpData.studentID" required="required">
			</div>
			<hr class="blank">
